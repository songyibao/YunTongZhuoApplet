            ...
            n = t.algo.SHA1 = i.extend({
                ...
                _doProcessBlock: function (t, e) {
                    for (var n = this._hash.words, r = n[0], i = n[1], o = n[2], a = n[3], c = n[4], h = 0; 80 > h; h++) {
                        ...
                        u = (r << 5 | r >>> 27) + c + s[h], u = 20 > h ? u + (1518500249 + (i & o | ~i & a)) : 40 > h ? u + (1859775393 + (i ^ o ^ a)) : 60 > h ? u + ((i & o | i & a | o & a) - 1894007588) : u + ((i ^ o ^ a) - 899497514), c = a, a = o, o = i << 30 | i >>> 2, i = r, r = u
                    }
        ...
        function () {
            ...
            t.algo.HMAC = t.lib.Base.extend({
                init: function (t, e) {
                    ...
                    for (var s = this._oKey = e.clone(), o = this._iKey = e.clone(), a = s.words, c = o.words, h = 0; h < r; h++) a[h] ^= 1549556828, c[h] ^= 909522486;
            ...
            t.enc.Base64 = {
                stringify: function (t) {
                    ...
                    for (var i = [], s = 0; s < n; s += 3)
                        for (var o = e[s >>> 2] >>> 24 - s % 4 * 8 & 255, a = e[s + 1 >>> 2] >>> 24 - (s + 1) % 4 * 8 & 255, c = e[s + 2 >>> 2] >>> 24 - (s + 2) % 4 * 8 & 255, h = o << 16 | a << 8 | c, u = 0; u < 4 && s + .75 * u < n; u++) i.push(r.charAt(h >>> 6 * (3 - u) & 63));
                    var f = r.charAt(64);
                    if (f)
        ...
        r = function (r) {
            ...
            var i = r.SecretId,
                ...
                l = function (e) {
                    var n, r, i, s = [],
                        o = f(e);
                    for (n = 0; n < o.length; n++) r = o[n], i = void 0 === e[r] || null === e[r] ? "" : "" + e[r], r = r.toLowerCase(), r = t(r), i = t(i) || "", s.push(r + "=" + i);
                    return s.join("&")
                },
            ...
            return ["q-sign-algorithm=sha1", "q-ak=" + g, "q-sign-time=" + y, "q-key-time=" + v, "q-header-list=" + m, "q-url-param-list=" + _, "q-signature=" + e.HmacSHA1(B, w).toString()].join("&")
        };
